...
def main():
    ...
    ## Required parameters
    parser.add_argument("--data_dir", default='../dataset/javaCorpus/line_completion', type=str,
                        help="The input data path.")
    parser.add_argument("--langs", default='java', type=str,
                        help="Languages to train, if all, train all languages in data_dir")
    parser.add_argument("--output_dir", default='../save/javaCorpus', type=str,
    ...
    parser.add_argument("--tokenizer_dir", type=str,default='gt2',
                        help="Pre-trained tokenizer dir. Required when training from scratch")
    parser.add_argument("--lit_file", default='../dataset/javaCorpus/literals.json', type=str,
    ...
    parser.add_argument('--log_file', type=str, default='completion_javaCorpus_eval.log')
